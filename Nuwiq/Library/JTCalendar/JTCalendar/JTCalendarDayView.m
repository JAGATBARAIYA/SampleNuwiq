...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    if(selected){
        if(!self.isOtherMonth){
            circleView.color = [UIColor colorWithRed:77.0/255.0 green:168.0/255.0 blue:183.0/255.0 alpha:1.0];//[self.calendarManager.calendarAppearance dayCircleColorSelected];
        ...
        if(!self.isOtherMonth){
            circleView.color = [UIColor colorWithRed:77.0/255.0 green:168.0/255.0 blue:183.0/255.0 alpha:1.0];//[self.calendarManager.calendarAppearance dayCircleColorToday];
        ...
        if(!self.isOtherMonth){
            ...
            textLabel.textColor = [UIColor colorWithRed:59.0/255.0 green:145.0/255.0 blue:72.0/255.0 alpha:1.0];//[self.calendarManager.calendarAppearance dayTextColorOtherMonth];
