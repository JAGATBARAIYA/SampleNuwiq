...
- (void)setDefaultValues
{
    ...
    self.menuMonthTextFont = [UIFont systemFontOfSize:20];
    self.weekDayTextFont = [UIFont systemFontOfSize:20];
    self.dayTextFont = [UIFont fontWithName:@"Arial" size:20];
    ...
    self.weekDayTextColor = [UIColor clearColor]; //[UIColor colorWithRed:152./256. green:147./256. blue:157./256. alpha:1.];
    
    [self setDayDotColorForAll:[UIColor yellowColor]];//[UIColor colorWithRed:43./256. green:88./256. blue:134./256. alpha:1.]];
    [self setDayTextColorForAll:[UIColor whiteColor]];
    
    self.dayTextColorOtherMonth = [UIColor colorWithRed:97./256. green:194./256. blue:79./256. alpha:1.];

    self.dayCircleColorSelected = [UIColor clearColor];
    self.dayTextColorSelected = [UIColor whiteColor];
    self.dayDotColorSelected = [UIColor yellowColor];
    ...
    self.dayDotColorToday = [UIColor yellowColor];
